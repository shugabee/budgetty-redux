...
import { addPurchase, requestBudgetData, removePurchase } from "../../redux/budgetReducer";
...
export default connect(mapStateToProps, { requestUserData, requestBudgetData, addPurchase, removePurchase })(
  Budget
);
